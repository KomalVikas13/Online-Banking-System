...
public class RecurringTransactionController {
    ...
    public ResponseEntity<Boolean> checkAutoPayStatus(@RequestBody RecurringTransaction recurringTransaction) {
        Boolean isEnabled = recurringTransactionService.isSetOnAutoPay(recurringTransaction.getAccountId(), recurringTransaction.getBillType());
